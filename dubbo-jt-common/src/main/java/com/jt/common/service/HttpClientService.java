...
public class HttpClientService {
	...
	/*
	 * 1.编辑get请求 动态拼接参数localhost:8091?id=1&name=tom
	 * 
	 */
	public String get(String url, Map<String, String> params, // 用map封装参数
			String charset) {
		String result = null;
		// 1.判断字符集编码是否为空
		...
		try {
			...
			CloseableHttpResponse httpResponse = httpClient.execute(httpGet);// 执行后台得到响应
			// 5.判断响应结果是否正确
	...
	/*
	 * String paramUrl=url+"?"; for (Map.Entry<String,String> entry :
	 * params.entrySet()) {
	 * 
